...
documents_file = os.path.join(current_path, 'fixtures/documents.json')
directories_file = os.path.join(current_path, 'fixtures/directories.json')

with open(directories_file, 'r', encoding='utf8') as out_directories:
    directories = json.load(out_directories)
with open(documents_file, 'r', encoding='utf8') as out_documents:
    documents = json.load(out_documents)
